...
export default function RootLayout({children}){return <html lang="en"><body className={manrope.variable}><MenuImportActions/><BulkMenuActions/><SafetyConfirmation/><CostControlUX/><ShelfSenseOperations/>{children}</body></html>}
