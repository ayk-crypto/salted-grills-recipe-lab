...
export default function IngredientCostPage(){
 ...
 const [editItem,setEditItem]=useState(null),[notice,setNotice]=useState(''),[importOpen,setImportOpen]=useState(false),[selected,setSelected]=useState({}),[deleteConfirm,setDeleteConfirm]=useState(null),[bulkCategory,setBulkCategory]=useState('');
 ...
 function buildRow(i,recipes,shelfMeta){
   ...
   const category=String(i.ingredient_category||shelfItem?.category||'Uncategorized');
