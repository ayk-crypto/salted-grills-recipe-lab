...
export default function CostControlApp(){
 ...
 async function startEditor(type,r=null){
  ...
  setEditor({
   ...
   selling_price:meta.selling_price||'',target_food_cost:meta.target_food_cost||35,
   delivery_commission_pct:meta.delivery_commission_pct??costModel.delivery_commission_pct??0,
   payment_fee_pct:meta.payment_fee_pct??costModel.payment_fee_pct??0,
   other_variable_pct:meta.other_variable_pct??costModel.other_variable_pct??0,
   delivery_fixed_cost:meta.delivery_fixed_cost||0,
